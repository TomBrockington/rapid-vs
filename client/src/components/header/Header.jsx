...
function Header() {
  return (
    <header className='bg-gray-100 grid h-full pt-2 pb-8'>
      {/* Content */}
        ...
        <section className='relative grid gap-0 bg-center bg-main-bg bg-cover w-full bg-no-repeat h-full outline outline-4 outline-black rounded'>
          ...
          <div className='grid'>
            <section className='grid justify-center gap-1 lg:justify-start px-3 lg:w-fit lg:h-fit lg:gap-4 lg:p-4'>
              <article className='border-gray-100 rounded-xl h-fit mt-4 lg:mt-0 bg-main-colour text-center p-6'>
                <h1 className='text-4xl lg:text-7xl font-bold mb-2 font-sigmar'>
                  Rapid Van Solutions
                </h1>
                <h2 className='lg:text-3xl font-semibold my-1 leading-7 mb-2'>
            ...
            <section className='p-4 grid h-fit mt-32 pt-10 lg:mt-4'>
              <article className='font-sigmar rounded-xl h-fit mt-4 grid lg:grid-cols-5 gap-2 lg:gap-4 lg:p-4 bg-transparent-orange text-center p-2 lg:text-2xl'>
                <span className='p-2 outline outline-2 outline-black rounded-lg bg-main-colour hover:bg-orange-500 cursor-pointer font-medium'>
                  White Goods
                </span>
                <span className='p-2 outline outline-2 outline-black rounded-lg bg-main-colour hover:bg-orange-500 cursor-pointer font-medium'>
                  Long Distance
              ...
              <article className='grid grid-flow-col leading-4 rounded-xl h-fit mt-4 bg-main-colour text-sm text-center p-2 lg:text-xl'>
                <div className='grid items-center'>
                  <p>
                    Registered and fully licenced for{' '}
                    <span className='italic'>eco-friendly</span> waste disposal,
                    and <span className='font-semibold'>Category 3 </span>waste.
                  </p>
                </div>
                <section className='p-2'>
                  <img
                    className='h-full object-fill rounded lg:h-[100px]'
                    src={WasteImg}
              ...
              <div className='hidden sm:grid p-4 rounded-xl bg-main-colour hover:bg-orange-500 cursor-pointer font-medium w-fit absolute bottom-4 left-4'>
